...
const NuevoEmpleado = () => {
  ...
  const submitData = async (data) => {
    ...
    if (!employeeId) {
      ...
      await axios
        .post(`${config.API_URL}employees/update/${employeeId}`, formData, {
          headers: {
            "Content-Type": "multipart/form-data",
          },
        })
            ...
            <div className="subcontenedor-form">
              ...
              <div className="form-group__input-group">
                ...
                <label className="label_imagen" htmlFor="imagen">
                  ...
                  <div className="contenedor-icon_imagen">
                    <BiImageAdd
                      className={
                        imagen != "" ? "input_imagen BiImageAdd" : "icon_imagen"
                      }
                    />
                    <BiImage
                      className={
                        imagen != "" ? "icon_imagen BiImage" : "input_imagen"
                      }
                    />
                  </div>
                </label>
              ...
              <div className="form-group__input-group">
                ...
                {errors.dni?.type === "maxLength" && (
                  <p className="error-message">Ingresar DNI correcto</p>
                )}
            ...
            <div className="subcontenedor-form">
              ...
              <div className="form-group__input-group">
                ...
                >
                  ...
                  <option value="Soporte y desarrollo">Soporte y desarrollo</option>
                </select>
