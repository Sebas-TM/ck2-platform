              ...
              >
                ...
                <td className="data data_opciones">
                  ...
                  <button
                    ...
                    className={rol != 3 ? "btn_option edit" : "disable-button"}
                  >
                  ...
                  <button
                    ...
                    className={
                      rol == 1 ? "btn_option delete" : "disable-button"
                    }
                  >
        ...
        {sortedEmployees.map((sortedEmployee, index) => (
          ...
          >
            <div
              ...
              onClick={() =>
                navigate(`/menu/recursos_humanos/empleado/${sortedEmployee.id}`)
              }
            >
              <div className="container">
                ...
                <div className="datos-principales">
                  ...
                  <p className="datos-principales_dni">{sortedEmployee.dni}</p>
                </div>
              </div>
              <div className="contenedor-info">
                <div className="contenedor-datos">
                  <p className="dato">Celular:</p>
                  <p className="dato-info">{sortedEmployee.celular}</p>
                </div>
                <div className="contenedor-datos">
                  <p className="dato">Área:</p>
                  <p className="dato-info">{sortedEmployee.area}</p>
                </div>
                <div className="contenedor-datos">
            ...
            <div className="data data_opciones">
              ...
              <button
                onClick={() => eliminarEmpleado(sortedEmployee.id)}
                className={rol == 1 ? "btn_option delete" : "disable-button"}
              >
                <FiTrash className="icon" />
              </button>
            </div>
