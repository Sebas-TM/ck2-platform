            ...
            <header className="contenedor-header">
                <div className="header">
                    <ul className="subcontenedor-header">
                        ...
                        <Link
                            to="/menu/usuarios"
                            className={rol != 1 ? "isNotAdmin" : "list disable"}
                        >
                    ...
                    <ul className="contenedor-usuario">
                        ...
                        <li
                            onClick={openMenu}
                            className="contenedor-img-usuario"
                        >
                            <img
                    ...
                    <ul
                        className={`contenedor-menu__user ${
                            menuToggle ? "show" : ""
                        }`}
                    >
                        ...
                        <li className="list_user" onClick={cerrarSesion}>
                            ...
                            {/* <p className={`texto_header ${menuToggle ? "show" : ""}`}>Cerrar sesión</p> */}
                        </li>
                    </ul>
                </div>
            </header>
